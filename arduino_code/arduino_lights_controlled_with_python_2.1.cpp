...
void setup()
{
  ...
  else
  {
    ...
    Serial.println(Strip1green);
    Serial.println(Strip1red);
    ...
    Serial.println(Strip2blue);
    Serial.println(Strip2brightness);
    
    Serial.println("data3:");
    Serial.println(Strip3mode);
    Serial.println(Strip3green);
    Serial.println(Strip3red);
    Serial.println(Strip3blue);
    Serial.println(Strip3brightness);
  }
}
