...
def data_to_arduino(mode, green, red, blue, num_led, brightness):
    ...
    primary_red = entry_primary_red.get()
    primary_green = entry_primary_green.get()
    primary_blue = entry_primary_blue.get()

    secondary_red = entry_secondary_red.get()
    secondary_green = entry_secondary_green.get()
    secondary_blue = entry_secondary_blue.get()
    print(current_strip)
    while x == 1:
        data[0] = int(mode)
        data[1] = int(green)
        ...
        data[6] = int(primary_red)
        data[7] = int(primary_green)
        data[8] = int(primary_blue)
        data[9] = int(secondary_red)
        data[10] = int(secondary_green)
        data[11] = int(secondary_blue)
        x += 1
...
entry_primary_red = Entry(color_frame, width=3)
entry_primary_red.pack()
entry_primary_red.place(relx=0.25, rely=0.1)

entry_primary_green = Entry(color_frame, width=3)
entry_primary_green.pack()
entry_primary_green.place(relx=0.25, rely=0.25)

entry_primary_blue = Entry(color_frame, width=3)
entry_primary_blue.pack()
entry_primary_blue.place(relx=0.25, rely=0.4)

entry_secondary_red = Entry(color_frame, width=3)
entry_secondary_red.pack()
entry_secondary_red.place(relx=0.4, rely=0.1)

entry_secondary_green = Entry(color_frame, width=3)
entry_secondary_green.pack()
entry_secondary_green.place(relx=0.4, rely=0.25)

entry_secondary_blue = Entry(color_frame, width=3)
entry_secondary_blue.pack()
entry_secondary_blue.place(relx=0.4, rely=0.4)
